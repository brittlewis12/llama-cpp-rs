...
impl LlamaContext<'_> {
    ...
    pub fn copy_cache(&mut self, src: i32, dest: i32, size: i32) {
        unsafe {
            ...
            llama_cpp_sys_2::llama_memory_seq_cp(mem, src, dest, 0, size)
        }
    }
    ...
    pub fn copy_kv_cache_seq(
        ...
        unsafe {
            let mem = llama_cpp_sys_2::llama_get_memory(self.context.as_ptr());
            llama_cpp_sys_2::llama_memory_seq_cp(mem, src, dest, p0, p1);
        }
        Ok(())
    }
    ...
    pub fn clear_kv_cache_seq(
        ...
        Ok(unsafe {
            let mem = llama_cpp_sys_2::llama_get_memory(self.context.as_ptr());
            llama_cpp_sys_2::llama_memory_seq_rm(mem, src, p0, p1)
        })
    }
    ...
    pub fn llama_kv_cache_seq_keep(&mut self, seq_id: i32) {
        unsafe {
            let mem = llama_cpp_sys_2::llama_get_memory(self.context.as_ptr());
            llama_cpp_sys_2::llama_memory_seq_keep(mem, seq_id)
        }
    }
    ...
    pub fn kv_cache_seq_add(
        ...
        unsafe {
            let mem = llama_cpp_sys_2::llama_get_memory(self.context.as_ptr());
            llama_cpp_sys_2::llama_memory_seq_add(mem, seq_id, p0, p1, delta);
        }
        Ok(())
    }
    ...
    pub fn kv_cache_seq_div(
        ...
        unsafe {
            let mem = llama_cpp_sys_2::llama_get_memory(self.context.as_ptr());
            llama_cpp_sys_2::llama_memory_seq_div(mem, seq_id, p0, p1, d)
        }
        Ok(())
    }
    ...
    pub fn kv_cache_seq_pos_max(&self, seq_id: i32) -> i32 {
        unsafe {
            let mem = llama_cpp_sys_2::llama_get_memory(self.context.as_ptr());
            llama_cpp_sys_2::llama_memory_seq_pos_max(mem, seq_id)
        }
    }
}
